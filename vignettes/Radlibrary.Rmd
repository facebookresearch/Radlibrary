...
We've provided a useful way to extract data from the `adlib_data_response` object via a modified `as_tibble` wrapper from `dplyr`. 

```{r, eval = FALSE}
results.tibble <- as_tibble.adlib_data_response(results)
```
